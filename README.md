...
║                                                                     ║
║ ○ <a href="https://github.com/Zhovten-Games/InterDeadIT">InterDeadIT</a> (website / entry point)                               ║
...
║═════════════════════════════════════════════════════════════════════║
║ This repository is the public documentation hub for the InterDead   ║
║ project, focused specifically on materials related to the game’s    ║
║ development. It contains curated reference notes, primers, and      ║
║ technical/creative background documents that are safe to share      ║
║ outside our private workspace. Internal development documents may   ║
║ link here, but this library does not reference private              ║
║ repositories.                                                       ║
║═════════════════════════════════╦═══════════════════════════════════║
